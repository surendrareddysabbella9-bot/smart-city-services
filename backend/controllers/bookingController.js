...
export const createBooking = async (req, res) => {
  const { worker_id, service_id, description, start_time, end_time, latitude, longitude } = req.body;
  ...
  try {
    ...
    const result = await client.query(
      'INSERT INTO Bookings (customer_id, worker_id, service_id, description, start_time, end_time, status, booking_date, latitude, longitude) VALUES ($1, $2, $3, $4, $5, $6, $7, NOW(), $8, $9) RETURNING *',
      [executing_customer_id, worker_id, service_id || 1, description, start, end, 'Pending', latitude, longitude]
    );
